...
class _FineTuneWorkspaceState extends State<FineTuneWorkspace> {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const Text('Precise, optional controls — only what applies to this '
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            ...
            onTap: () => setState(
                () => open ? _open.remove(cat) : _open.add(cat)),
            child: Padding(
    ...
    return Wrap(
      ...
      children: [
        for (final p in StudioController.finishPresets)
          _chip('v2-ft-finish-${_slug(p.$1)}', p.$1,
              selected: '${fx.toJson()}' == '${p.$2.toJson()}' &&
      ...
      children: [
        ...
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final a in FillAlgorithm.values)
            _chip('v2-ft-fill-${a.name}', _fillLabel(a),
                selected: comp.fillAlgorithm == a,
                onTap: () =>
                    _c.setComp(comp.copyWith(fillAlgorithm: a))),
        ]),
        const SizedBox(height: 10),
        _sub('Density'),
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final d in Density.values)
            _chip('v2-ft-density-${d.name}', _cap(d.name),
                selected: comp.density == d,
                onTap: () => _c.setComp(comp.copyWith(density: d))),
        ]),
        const SizedBox(height: 10),
        _stepper('Copies per country', 'v2-ft-copies', comp.copiesPerCountry, 1,
            6, (v) => _c.setComp(comp.copyWith(copiesPerCountry: v))),
        _slider('Scatter', 'v2-ft-jitter', comp.jitter, 0, 1,
            (v) => _c.setComp(comp.copyWith(jitter: v))),
        _reset('v2-ft-reset-layout',
            () => _c.setComp(comp.copyWith(
  ...
  Widget _graphic() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _slider('Size', 'v2-ft-clip-scale', clip.scale, 0.3, 1.0,
            (v) => _c.setClip(clip.copyWith(scale: v))),
        _slider('Rotation', 'v2-ft-clip-rotation', clip.rotationDeg, -45, 45,
            (v) => _c.setClip(clip.copyWith(rotationDeg: v))),
        _slider('Corner radius', 'v2-ft-clip-corner', clip.cornerRadius, 0, 1,
            (v) => _c.setClip(clip.copyWith(cornerRadius: v))),
        _slider('Feather', 'v2-ft-clip-feather', clip.feather, 0, 1,
            (v) => _c.setClip(clip.copyWith(feather: v))),
        _reset(
            'v2-ft-reset-graphic',
            () => _c.setClip(clip.copyWith(
                scale: 1, rotationDeg: 0, cornerRadius: 0, feather: 0))),
      ],
    );
  }
      ...
      children: [
        ...
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final c in TextCase.values)
            _chip('v2-ft-case-${c.name}', _caseLabel(c),
                selected: t.textCase == c,
                onTap: () => _c.setTypography(Typography(
        ...
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final p in TextPlacement.values)
            _chip('v2-ft-textpos-${p.name}', _cap(p.name),
        ...
        const SizedBox(height: 10),
        _chip('v2-ft-statement', 'Lead with the count',
            selected: comp.statementHero,
            onTap: () => _c
                .setComp(comp.copyWith(statementHero: !comp.statementHero))),
        _reset(
            'v2-ft-reset-text',
            () {
      ...
      children: [
        ...
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final t in StudioController.colourTreatments)
            _chip('v2-ft-colour-${_slug(t.$1)}', t.$1,
                selected: _c.colourStrategy == t.$2 &&
                    ((t.$3 >= 0.3) == (_c.vintageGrade >= 0.3)),
                onTap: () => _c.setColourTreatment(t)),
        ]),
        const SizedBox(height: 10),
        _slider('Vintage grade', 'v2-ft-vintage', _c.vintageGrade, 0, 1,
            _c.setVintageGrade),
      ...
      children: [
        ...
        Wrap(spacing: 6, runSpacing: 6, children: [
          for (final s in TearStyle.values)
            _chip('v2-ft-tear-${s.name}', _tearLabel(s),
                selected: e.style == s,
                onTap: () => _c.setEdges(e.copyWith(style: s))),
        ]),
        const SizedBox(height: 10),
        _slider('Damage', 'v2-ft-edge-damage', e.edgeDamage, 0, 1,
            (v) => _c.setEdges(e.copyWith(edgeDamage: v))),
        _slider('Rip depth', 'v2-ft-edge-depth', e.maxDepth, 0, 0.5,
            (v) => _c.setEdges(e.copyWith(maxDepth: v))),
        _slider('Fray', 'v2-ft-edge-fray', e.frayAmount, 0, 1,
            (v) => _c.setEdges(e.copyWith(frayAmount: v))),
        _slider('Corner damage', 'v2-ft-edge-corner', e.cornerDamage, 0, 1,
            (v) => _c.setEdges(e.copyWith(cornerDamage: v))),
        _slider('Asymmetry', 'v2-ft-edge-asym', e.asymmetry, 0, 1,
  ...
  Widget _effects() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _slider('Distress', 'v2-ft-fx-distress', fx.distress, 0, 1,
            (v) => _c.setFx(fx.copyWith(distress: v))),
        _slider('Grain', 'v2-ft-fx-grain', fx.grain, 0, 1,
            (v) => _c.setFx(fx.copyWith(grain: v))),
        _slider('Fade', 'v2-ft-fx-fade', fx.fade, 0, 1,
            (v) => _c.setFx(fx.copyWith(fade: v))),
        _slider('Cracks', 'v2-ft-fx-cracks', fx.cracks, 0, 1,
            (v) => _c.setFx(fx.copyWith(cracks: v))),
        _slider('Acid wash', 'v2-ft-fx-acidwash', fx.acidWash, 0, 1,
            (v) => _c.setFx(fx.copyWith(acidWash: v))),
        _slider('Tie-dye', 'v2-ft-fx-tiedye', fx.tieDye, 0, 1,
            (v) => _c.setFx(fx.copyWith(tieDye: v))),
        _slider('Shatter', 'v2-ft-fx-shatter', fx.shatter, 0, 1,
            (v) => _c.setFx(fx.copyWith(shatter: v))),
        _slider('Spikes', 'v2-ft-fx-spikes', fx.shatterSpikes, 0, 1,
            (v) => _c.setFx(fx.copyWith(shatterSpikes: v))),
        _slider('Halftone', 'v2-ft-fx-halftone', fx.halftone, 0, 1,
            (v) => _c.setFx(fx.copyWith(halftone: v))),
        _slider('Halftone scale', 'v2-ft-fx-halftonescale', fx.halftoneScale, 2,
            12, (v) => _c.setFx(fx.copyWith(halftoneScale: v))),
        _slider('Ripple', 'v2-ft-fx-ripple', fx.rippleAmp, 0, 1,
            (v) => _c.setFx(fx.copyWith(rippleAmp: v))),
        _slider('Ripple frequency', 'v2-ft-fx-ripplefreq', fx.rippleFreq, 2, 20,
            (v) => _c.setFx(fx.copyWith(rippleFreq: v))),
        _reset(
            'v2-ft-reset-effects',
            () => _c.setFx(fx.copyWith(
                distress: 0,
                grain: 0,
                fade: 0,
                cracks: 0,
  ...
  Widget _print() {
    ...
    return Wrap(
      ...
      runSpacing: 6,
      children: [
        _chip('v2-ft-print-none', 'None',
            selected: none, onTap: () => _c.setFx(only('none'))),
        _chip('v2-ft-print-riso', 'Riso',
            selected: fx.riso > 0, onTap: () => _c.setFx(only('riso'))),
        _chip('v2-ft-print-newsprint', 'Newsprint',
            selected: fx.newsprint > 0,
            onTap: () => _c.setFx(only('newsprint'))),
        _chip('v2-ft-print-sunfaded', 'Sun-faded',
            selected: fx.sunFaded > 0,
            onTap: () => _c.setFx(only('sunFaded'))),
        _chip('v2-ft-print-photocopy', 'Photocopy',
  ...
  Widget _slider(String label, String id, double value, double min, double max,
  ...
  Widget _stepper(String label, String id, int value, int min, int max,
