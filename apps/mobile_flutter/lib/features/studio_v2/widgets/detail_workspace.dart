...
class DetailWorkspace extends StatelessWidget {
  ...
  Widget _silhouetteRow(BuildContext context, ClipShape shape) {
    ...
    if (all.isEmpty) {
      return const Text(
        'No bundled art for this shape yet.',
                    ...
                    return Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            kCountryNames[cc.toUpperCase()] ?? cc.toUpperCase(),
                          ...
                          children: [
                            for (final slug in slugs)
                              _thumb(slug, slug == currentSlug, () {
                                c.setClip(Clip.shape(widget.shape, code: slug));
