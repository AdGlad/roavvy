...
describe('buildClues', () => {
    ...
    it('always returns an array of exactly 5 clues', () => {
        expect((0, dailyChallenge_1.buildClues)(culturalNorth)).toHaveLength(5);
        expect((0, dailyChallenge_1.buildClues)(naturalSouth)).toHaveLength(5);
        expect((0, dailyChallenge_1.buildClues)(mixedRecent)).toHaveLength(5);
    });
});
//# sourceMappingURL=dailyChallenge.test.js.map